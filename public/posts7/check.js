document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        if(caseNum == 'case_2'||caseNum == 'case_3'||caseNum == 'case_6'||caseNum == 'case_5'){
            window.location.href = `/posts/8`;
        }else{
            const apiResponse = await fetch(`https://asia-northeast3-life-legacy-dev.cloudfunctions.net/api/posts/check/7`,{
                method: 'GET',
                credentials: 'include',
            });
