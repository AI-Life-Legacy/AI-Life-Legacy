...
questions = {
    ...
    "6": "자녀들이 성장하면서 부모로서 가장 보람을 느꼈던 순간은 언제였나요?"
};
    ...
    if (responseText !== '') {
        ...
        if (!isResult) {
            ...
            try {
                ...
                await fetch('https://asia-northeast3-life-legacy-dev.cloudfunctions.net/api/write/save', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
...
function initializeSpeechRecognition() {
    ...
    recognition.onend = () => {
        recognizing = false;
        document.getElementById('voiceLabelStart').innerText = '음성 입력';
